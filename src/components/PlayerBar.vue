<template>
    ...
    <div class="playerbar__container">
        <span class="icon__container">
            ...
            <audio ref="audio" :src="url_song" controls autoplay>
            </audio>
        </span>
        <input type="range">
    </div>
...
export default {
    ...
    watch:  {
        ...
        // checkAudio(newVal){
        //     var img = document.querySelector('.img_song');
        //     if(!newVal){
        //         img.style.animation = "none";
        //     }
        //     else{
        //         img.style.animation = "spin 7s linear infinite";
        //     }
        // }
    }
}
